...
<body>
    ...
    <a type="button" class="navlink btn btn-primary" href="tambah.php">Tambah Data</button>
    </a>
        <hr>
                ...
                if (mysqli_num_rows($sql) > 0) {
                    ...
                    while ($data = mysqli_fetch_assoc($sql)) {
						...
						<tr>
                            ...
                            <td>' . $data['agama'] . '</td>
                            <td>' . $data['olah_raga'] . '</td>
                            <td align="center"><img src=' . "file/" . $data['nama_file'] . ' width="100px"></td>
							<td>
